            ...
            <div class="col-md-12">
                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                @foreach ($tenor as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->tenor }} Tahun</td>
                                        <td>
                                            <div class="form-inline">
                                                <a href="{{ route('tenor.edit', $item->id) }}" class="mr-2">
                                                ...
                                                <form action="{{ route('tenor.destroy', $item->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
                        ...
                        {{$tenor->appends(Request::all())->links('vendor.pagination.custom')}}
                    </div>
                </div>
            </div>
        </div>
