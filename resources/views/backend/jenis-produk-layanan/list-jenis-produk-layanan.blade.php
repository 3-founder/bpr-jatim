        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-header">List Jenis Produk & Layanan
                    ...
                    <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-inline">
                                                <a href="{{ route('jenis-produk-layanan.edit', $item->id) }}" class="mr-2">
                                                ...
                                                <form action="{{ route('jenis-produk-layanan.destroy', $item->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
                        ...
                        {{$jenis->appends(Request::all())->links('vendor.pagination.custom')}}
                    </div>
                </div>
            </div>
        </div>
