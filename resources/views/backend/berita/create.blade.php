                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('berita.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input name="judul" id="judul" placeholder="Judul Berita" type="text" class="form-control @error('judul') is-invalid @enderror">
                                @error('judul')
                            ...
                            <div class="position-relative form-group">
                                ...
                                <textarea name="konten" id="konten" class="form-control @error('konten') is-invalid @enderror" cols="30" rows="5"></textarea>
                                @error('konten')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
