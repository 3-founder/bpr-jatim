        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-header">List Komposisi Saham
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>{{ ucwords($item->pemilik_saham) }}</td>
                                        <td>{{ ucwords($item->jenis) }}</td>
                                        <td>{{ rupiahFormat($item->lembar) }}</td>
                                        <td>{{ rupiahFormat($item->nominal) }}</td>
                                        <td>
                                            <div class="form-inline">
                                                <a href="{{ route('komposisi-saham.edit', $item->id) }}" class="mr-2">
                                                ...
                                                <form action="{{ route('komposisi-saham.destroy', $item->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
