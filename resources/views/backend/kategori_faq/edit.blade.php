        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Jenis FAQ</h5>
                        <form action="{{ route('kategori-faq.update', $data->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="position-relative form-group">
                                ...
                                <textarea name="keterangan" id="keterangan" class="form-control @error('judul') is-invalid @enderror" cols="30" rows="5">{{ old('keterangan', $data->keterangan) }}</textarea>
                                @error('keterangan')
                                    <div class="span text-danger">
                                        {{ $message }}
                                    </div>
