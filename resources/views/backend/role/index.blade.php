        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="main-card mb-3 card">
                    <div class="card-header">List Role
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-inline">
                                                <a href="{{ route('role.edit', $item->id) }}" class="mr-2">
                                                ...
                                                <a href="{{ route('role.show', $item->id) }}" class="mr-2">
                                                    <button type="button" id="PopoverCustomT-1" class="btn btn-warning btn-md" data-toggle="tooltip" title="Detail" data-placement="top"><span class="fa fa-eye"></span></button>
                                                </a>
